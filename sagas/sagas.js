...
const fetchTweetsData = () => {
 return axios.get(`http://${IP_ADDRESS}:3000/tweets`).then((response) => {
...
const fetchTweetRepliesData = () => {
 return axios.get(`http://${IP_ADDRESS}:3000/tweetReplies`).then((response) => {
  console.log(response);
  return response.data;
 });
};
...
const fetchUserTweetsData = () => {
 return axios.get(`http://${IP_ADDRESS}:3000/userTweets`).then((response) => {
  console.log(response);
  return response.data;
 });
};
...
const attemptLogin = () => {
 return axios
  .get(`http://${IP_ADDRESS}:3000/login`)
  .then((response) => {
   return response.data;
  })
  .catch((err) => {
...
const postTweet = (payload) => {
 return axios.post(`http://${IP_ADDRESS}:3000/tweets`, {
