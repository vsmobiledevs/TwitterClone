  ...
  return (
   <Container>
    ...
    <Content style={{backgroundColor: "white"}}>
     ...
     <View>
      <Text style={{fontSize: 22, padding: 10}}>{this.tweet.tweetContent}</Text>
     </View>
     ...
     <View style={styles.tweetFooter}>
      <View>
       <Button transparent dark style={{paddingBottom: 0, paddingTop: 0}}>
         ...
         <View style={styles.tweetReply}>
          ...
          <View
           ...
           <View style={{flexDirection: "row", maxHeight: 22}}>
            ...
            <Text style={{color: "#888", flex: 1, paddingLeft: 5}}>
             {"@" + item.user.username}
            </Text>
           </View>
           <View
           ...
           <View
            style={StyleSheet.flatten([styles.tweetFooter, {width: "100%"}])}>
            ...
            <View style={styles.footerIcons}>
             <Button transparent dark>
              ...
              <Text style={{fontSize: 14}}>{item.retweets}</Text>
             </Button>
            </View>
            <View style={styles.footerIcons}>
             <Button transparent dark>
              <Icon name='ios-heart-outline' style={{fontSize: 20}} />
              <Text style={{fontSize: 14}}>{item.likes}</Text>
             </Button>
            </View>
            <View style={styles.footerIcons}>
             <Button transparent dark>
              <Icon name='ios-mail-outline' style={{fontSize: 20}} />
             </Button>
            </View>
           </View>
          </View>
